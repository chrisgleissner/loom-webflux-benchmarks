...
parameterization = [
    ...
    ("results2.csv",
     [],
     [[Color(name='royalblue', saturation=1.0, results=[0.0, 100.0]),
       Color(name='royalblue', saturation=0.97, results=[50.0, 100.0])],
      [Color(name='forestgreen', saturation=0.0, results=[0.0, 0.0]),
       Color(name='forestgreen', saturation=0.83, results=[1.5, 2.0])]]
     ),
    ("results3.csv",
     ["a1"],
    ...
    ("results.csv",
     ...
     [[Color(name='royalblue', saturation=0.11, results=[113.0, 115.0, 116.0]),
      ...
      [Color(name='royalblue', saturation=0.0, results=[12.0, 12.0, 12.0]),
       Color(name='royalblue', saturation=0.07, results=[997.0, 1007.0, 1007.0]),
       Color(name='royalblue', saturation=0.06, results=[4962.0, 5007.0, 5007.0]),
       Color(name='royalblue', saturation=0.06, results=[4962.0, 5007.0, 5007.0]),
       Color(name='royalblue', saturation=0.06, results=[9911.0, 10007.0, 10007.0]),
       Color(name='royalblue', saturation=0.0, results=[10006.0, 10007.0, 10007.0]),
       Color(name='royalblue', saturation=0.0, results=[10006.0, 10007.0, 10007.0]),
       Color(name='royalblue', saturation=0.46, results=[15289.0, 16742.0, 16774.0]),
       Color(name='royalblue', saturation=0.48, results=[13593.0, 14997.0, 15064.0]),
       Color(name='royalblue', saturation=0.47, results=[13431.0, 14761.0, 14779.0]),
       Color(name='royalblue', saturation=0.5, results=[13305.0, 14748.0, 14759.0]),
       Color(name='royalblue',
             saturation=0.56,
             results=[13024.0, 14752.0, 14768.0])],
      [Color(name='royalblue', saturation=0.0, results=[12.0, 12.0, 12.0]),
       ...
       Color(name='forestgreen',
             saturation=0.0,
             results=[10007.0, 10007.0, 10056.0]),
       Color(name='forestgreen',
             saturation=0.0,
             results=[10007.0, 10007.0, 10155.0]),
       Color(name='forestgreen',
             saturation=0.0,
             results=[10007.0, 10007.0, 10085.0]),
       Color(name='royalblue', saturation=0.02, results=[24950.0, 25007.0, 25007.0]),
       Color(name='royalblue', saturation=0.23, results=[24071.0, 25007.0, 25007.0]),
       Color(name='royalblue', saturation=0.26, results=[23930.0, 24999.0, 25007.0]),
       Color(name='royalblue', saturation=0.11, results=[24604.0, 25005.0, 25007.0]),
       Color(name='royalblue',
             saturation=0.21,
             results=[24151.0, 25007.0, 25007.0])],
