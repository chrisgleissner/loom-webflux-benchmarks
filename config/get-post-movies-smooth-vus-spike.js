...
const postMoviesUrl = __ENV.SERVICE_API_BASE_URL + "/movies?approach=" + __ENV.APPROACH + "&delayCallDepth=" + __ENV.DELAY_CALL_DEPTH + "&delayInMillis=" + __ENV.DELAY_IN_MILLIS
...
function getMoviesUrl(directorLastName) {
    return __ENV.SERVICE_API_BASE_URL + "/movies?directorLastName=" + directorLastName + "&approach=" + __ENV.APPROACH + "&delayCallDepth=" + __ENV.DELAY_CALL_DEPTH + "&delayInMillis=" + __ENV.DELAY_IN_MILLIS
}
